...
Поддерживаются две независимо версионируемые рабочие сборки: **LexPack 0.9.1-chrome для Chrome** и **LexPack 0.9.1-gost для Chromium-Gost**. Исправления безопасности общего кода проверяются для обоих вариантов. Старые распакованные копии не обновляются автоматически: после получения исправления замените файлы активного варианта и нажмите «Обновить» в `chrome://extensions`.
